...
export class StatsComponent implements OnInit {
  ...
  chartOptions3!: Partial<ChartOptions3>;
  chartOptions4!: Partial<ChartOptions4>;

  chartOptions5!: Partial<ChartOptions5>;
  ...
  constructor() {
    ...
    this.chartOptions3 = {
      ...
      labels: ['Automobile', 'Proprietaires', 'societes', 'Marques'],
    };
    ...
    this.chartOptions4 = {
      ...
      labels: ['Modele', 'categorie', 'typeAuto', 'compte', 'Agent'],
      chart: {
        type: 'polarArea',
      },
      stroke: {
      ...
      this.chartOptions2.series = [
        {
          name: 'series1',
          data: [
            this.generateRandomInteger(100),
            this.generateRandomInteger(100),
            this.generateRandomInteger(100),
            this.generateRandomInteger(100),
            this.generateRandomInteger(100),
  ...
  generateRandomFloatInRange(min: number, max: number) {
  ...
  updateOptions(option: any): void {
    ...
    let op: '1m' | '6m' | '1y' | '1yd' | 'all' = option;
    this.chart.updateOptions(this.updateOptionsData[op], false, true, true);
  }

  initChart5(): void {
    this.chartOptions5 = {
      title: {
        text: 'Chiffre d\'affaire sogea',
      },
      series: [
        {
          data: data,
